#!/usr/bin/env node
/**
 * Generates extension bridge files based on uclaw-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'uclaw-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure uclaw-extensions.json and link the package.',
