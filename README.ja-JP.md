...
[Releases](https://github.com/DepartureZSH/UClaw/releases)ページから、お使いのプラットフォーム向けの最新リリースをダウンロードしてください。
...
- Windows ZIP では、アプリ横の `data/` に UClaw データを保存し、OpenClaw 実行ファイルは `data/workspace` に固定されます。
